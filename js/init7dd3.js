...
! function (o) {
   ...
   var e = {
      root: o(":root"),
      init: function () {
         e.BgImg(), e.imgToSVG(), e.rightPanelScroll(), e.rightNav(), e.tabs(), e.progress(), e.cursor(), e.portfolioCarousel(), e.testimonialCarousel(), e.loadBlogPosts(), e.movingPlaceholder(), e.contactForm(), e.scrollToAnchor(), e.pageWidthAnimation(), e.modal(), e.typed()
      },
      typed: function () {
      ...
      modal: function () {
         ...
         t.find(".extra_closer").on("mouseenter", function () {
            ...
            var n = o(this),
               ...
               i = n.attr("data-index"),
               l = r.attr("data-from");
            return s.attr("data-index", i), s.attr("data-from", l), o("body").addClass("modal"), t.addClass("opened"), t.find(".modal_in").html(a), e.modal_prevnext(s, t), e.imgToSVG(), e.BgImg(), !1
      ...
      modal_prevnext: function (e, t) {
         ...
         e.find("a").off().on("click", function () {
            ...
            }, 500), o(".resumo_fn_modalbox .modal_content").stop().animate({
               scrollTop: 0
            }, 500, "swing"), n.modal_prevnext(e, t), n.imgToSVG(), n.BgImg(), !1
         })
      },
      scrollToAnchor: function () {
         o('a[href^="#"]').not('[href="#"]').not('[href^="#tab"]').on("click", function () {
            var e = o(this),
               t = o(e.attr("href"));
            if (t.length) return o("html, body").animate({
               scrollTop: t.offset().top
            }, 1e3), o("#nav ul li").css({
               transitionDelay: "0ms"
            }), o(".resumo_fn_wrapper").removeClass("nav-opened nav-hover-close"), o(".resumo_fn_navigation .nav_footer").removeClass("ready"), !1
      ...
      pageWidthAnimation: function () {
         e.changeWidth(), o(window).on("scroll", function () {
            e.changeWidth()
         })
      },
      changeWidth: function () {
         var t = o(window).scrollTop(),
            n = 0;
         t > 0 && !o("body").hasClass("scrolled") ? (o("body").addClass("scrolled"), n++) : 0 === t && o("body").hasClass("scrolled") && (o("body").removeClass("scrolled"), n++), n > 0 && setTimeout(function () {
      ...
      contactForm: function () {
         o("#send_message").on("click", function () {
            var e = o(".resumo_fn_contact .contact_form"),
               ...
               i = r.data("success"),
               l = e.data("email");
            return r.empty(), "" === t || "" === n || "" === a || "" === l || "" === s ? o(".empty_notice").slideDown(500).delay(2e3).slideUp(500) : o.post("modal/contact.php", {
               ajax_name: t,
               ajax_email: n,
               ajax_emailto: l,
               ajax_message: a,
               ...
               r.append(o), r.find(".contact_error").length ? r.slideDown(500).delay(2e3).slideUp(500) : (r.append("<span class='contact_success'>" + i + "</span>"), r.slideDown(500).delay(4e3).slideUp(500)), "" === o && e[0].reset()
            }), !1
         })
      },
      movingPlaceholder: function () {
         o(".resumo_fn_contact .input_wrapper").each(function () {
            ...
            "" === t.val() && e.removeClass("active"), t.on("focus", function () {
               e.addClass("active")
            }).on("blur", function () {
      ...
      loadBlogPosts: function () {
         o(".resumo_fn_blog_list .load_more a").on("mousedown", function () {
            var e = o(this),
               t = e.find(".text");
            ...
            return !e.hasClass("loading") && !e.hasClass("done") && (e.addClass("loading"), setTimeout(function () {
               e.closest(".resumo_fn_blog_list").find(".be_animated").each(function (e, t) {
                  setTimeout(function () {
      ...
      testimonialCarousel: function () {
         o(".resumo_fn_testimonials .owl-carousel").each(function () {
            ...
            e.owlCarousel({
               ...
               items: 1,
               dots: !1
            }), e.trigger("refresh.owl.carousel"), e.on("changed.owl.carousel", function () {
      ...
      cursor: function () {
         if (o(".frenify-cursor").length) {
            ...
            }), n.style.visibility = "visible", a.style.visibility = "visible", o("body").on("mouseenter", t, function () {
            ...
            }), o("body").on("mousedown", t, function () {
            ...
            }), o("body").on("mouseenter", ".dark-section", function () {
      ...
      recallProgress: function (o) {
         o.find(".progress_bg").css({
            width: "0%"
         }), o.find(".progress_percent").html("").css({
            right: "100%"
         }), o.find(".progress_item").removeClass("open"), e.progress()
      },
      tabs: function () {
         o(".resumo_fn_tabs .tab_header a").off().on("click", function () {
            var t = o(this),
               n = t.parent(),
               a = t.closest(".resumo_fn_tabs");
            return !n.hasClass("active") && (n.siblings().removeClass("active"), a.find(".tab_content").children().removeClass("active"), n.addClass("active"), o(t.attr("href")).addClass("active"), e.recallProgress(a), !1)
         })
      },
      rightNav: function () {
         ...
         n.on("click", function () {
            return a.addClass("nav-opened"), r.each(function (e, t) {
               o(t).css({
                  transitionDelay: 200 * e + 700 + "ms"
               })
            }), setTimeout(function () {
               s.addClass("ready")
            }, i), !1
            ...
            return r.css({
               transitionDelay: "0ms"
            }), a.removeClass("nav-opened nav-hover-close"), s.removeClass("ready"), !1
      ...
      rightPanelScroll: function () {
         ...
         e.css({
            ...
            height: t.height() - a.outerHeight()
         }), o().niceScroll && (e.niceScroll({
            touchbehavior: !1,
            cursorwidth: 0,
            autohidemode: !0,
